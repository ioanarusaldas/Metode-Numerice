...
yi3=zeros(length(xi3),1);
	for i = 1 : length(xi1)
		yi1(i) = feval('splineC2_tensionat', xi1(i), x1, y1, dy1(1), dy1(2));
	endfor
	for i = 1 : length(xi2)
		yi2(i) = feval('splineC2_tensionat', xi2(i), x2, y2, dy2(1), dy2(2));
	endfor
  	for i = 1 : length(xi3)
		yi3(i) = feval('splineC2_tensionat', xi3(i), x3, y3, dy3(1), dy3(2));
	endfor
  hold on;
